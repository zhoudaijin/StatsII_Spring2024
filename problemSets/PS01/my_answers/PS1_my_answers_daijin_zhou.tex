...
\lstinputlisting[language=R, firstline=40, lastline=77]{PS1_my_answers_daijin_zhou.R}
...
\vspace{.5cm}
\lstinputlisting[language=R, firstline=84, lastline=106]{PS1_my_answers_daijin_zhou.R}
